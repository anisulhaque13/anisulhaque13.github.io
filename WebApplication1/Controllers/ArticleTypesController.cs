...
namespace Portfolio.Controllers
{
    public class ArticleTypesController : Controller
    {
        ...
        public ArticleTypesController(PFDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeName")] ArticleType articleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeName")] ArticleType articleType)
        {
