        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticalTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Articles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Articles_ArticleTypes_ArticalTypeId",
                        column: x => x.ArticalTypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_ArticalTypeId",
                table: "Articles",
                column: "ArticalTypeId");
        }
